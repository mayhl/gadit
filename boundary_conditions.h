...
//	template <typename DATATYPE, boundary_condtion_type::IDs BC_X > __device__ __forceinline__
...
//			}
//			break;
//		case boundary_condtion_type::CONSTANT_FLOW:
//			if (k0 == 0)
//			{
//
//				int km_l0 = k0_l0 - 1;
...
//	template <typename DATATYPE, boundary_condtion_type::IDs BC_Y0 > __device__ __forceinline__
...
//	template <typename DATATYPE, boundary_condtion_type::IDs BC_Y > __device__ __forceinline__
...
//	template <typename DATATYPE, boundary_condtion_type::IDs BC_X0, boundary_condtion_type::IDs BC_XN, 
//		                         boundary_condtion_type::IDs BC_Y0, boundary_condtion_type::IDs BC_YM> __device__ __forceinline__
...
//	template <typename DATATYPE, boundary_condtion_postition::IDs BC_POS, boundary_condtion_type::IDs BC_START, boundary_condtion_type::IDs BC_END> __device__ __forceinline__
//		void lhs_matrix_J
...
//		custom_J_row = false;
//
//		if (BC_POS == boundary_condtion_postition::INTERIOR)
//		{
...
//
//
//			if ((BC_POS == boundary_condtion_postition::FIRST) || (BC_POS == boundary_condtion_postition::SECOND) || (BC_POS == boundary_condtion_postition::THIRD))
//			{
//				switch (BC_START)
//				{
//				case boundary_condtion_type::SYMMETRIC:
...
//					{
//
//					case boundary_condtion_postition::FIRST:
...
//						break;
//					case boundary_condtion_postition::SECOND:
//						HSSS_LP_L0 = 1.0;		HSSS_LP_LP = 1.0;
//						HSSS_L0_L0 = -3.0;		HSSS_L0_LP = -3.0;
...
//						HS_LM_L0 = -1.0;		HS_LM_LP = -1.0;
//						break;
//					case boundary_condtion_postition::THIRD:
//						HSSS_LP_L0 = 1.0;		HSSS_LP_LP = 1.0;
//						HSSS_L0_L0 = -3.0;		HSSS_L0_LP = -3.0;
//						HSSS_LM_L0 = 3.0;		HSSS_LM_LP = 3.0;
//						HSSS_LMM_L0 = -1.0;		HSSS_LMM_LP = -1.0;
...
//
//						case boundary_condtion_postition::FIRST:
//							HSSS_LP_L0 =  0.0;		HSSS_LP_LP =   1.0;
//							HSSS_L0_L0 =  0.0;		HSSS_L0_LP =  -3.0;
//							HSSS_LM_L0 =  0.0;		HSSS_LM_LP =   0.0;
//							HSSS_LMM_L0 = 0.0;		HSSS_LMM_LP =  0.0;
//
//							HS_L0_L0 = 0.0;			HS_L0_LP =  1.0;
//							HS_LM_L0 = 0.0;			HS_LM_LP =  0.0;
//
//							J.a = 0;
//							J.b = 0;
//							J.c = 1;
...
//							HSSS_LP_L0 = 1.0;		HSSS_LP_LP = 1.0;
//							HSSS_L0_L0 = -3.0;		HSSS_L0_LP = -3.0;
//							HSSS_LM_L0 = 0.0;		HSSS_LM_LP = 3.0;
//							HSSS_LMM_L0 = 0;		HSSS_LMM_LP = 0.0;
//
//							HS_L0_L0 = 1.0;			HS_L0_LP = 1.0;
//							HS_LM_L0 = 0.0;			HS_LM_LP = -1.0;
//							break;
//						case boundary_condtion_postition::THIRD:
//							HSSS_LP_L0 =   1.0;		HSSS_LP_LP =   1.0;
//							HSSS_L0_L0 =  -3.0;		HSSS_L0_LP =  -3.0;
//							HSSS_LM_L0 =   3.0;		HSSS_LM_LP =   3.0;
//							HSSS_LMM_L0 =  0.0;		HSSS_LMM_LP = -1.0;
//
//							HS_L0_L0 = 1.0;			HS_L0_LP = 1.0;
//							HS_LM_L0 = -1.0;		HS_LM_LP = -1.0;
//							break;
...
//				}
//			}
//			else if ((BC_POS == boundary_condtion_postition::FIRST_LAST) || (BC_POS == boundary_condtion_postition::SECOND_LAST) || (BC_POS == boundary_condtion_postition::THIRD_LAST))
//			{
//				switch (BC_END)
//				{
//				case boundary_condtion_type::SYMMETRIC:
//					switch (BC_POS)
//					{
//					case boundary_condtion_postition::FIRST_LAST:
...
//						break;
//					case boundary_condtion_postition::SECOND_LAST:
...
//						HS_LM_L0 = -1.0;		HS_LM_LP = -1.0;
//						break;
//					case boundary_condtion_postition::THIRD_LAST:
//						HSSS_LP_L0 = 1.0;		HSSS_LP_LP = 1.0;
//						HSSS_L0_L0 = -3.0;		HSSS_L0_LP = -3.0;
//						HSSS_LM_L0 = 3.0;		HSSS_LM_LP = 3.0;
//						HSSS_LMM_L0 = -1.0;		HSSS_LMM_LP = -1.0;
...
#pragma region rhs_vector_bc
	...
	// Modifying corner ghost points to satisfy boundary conditions. 
	template <typename DATATYPE, boundary_condtion_type::IDs BC_X0, boundary_condtion_type::IDs BC_XN, boundary_condtion_type::IDs BC_Y0, boundary_condtion_type::IDs BC_YM> __device__ __forceinline__
		void rhs_vector_corner_blocks
		(reduced_device_workspace<DATATYPE> d_ws, dimensions dims, DATATYPE* d_h, int const  k0, int const l0, int const k0_l0)
	{
		...
		case boundary_condtion_type::SYMMETRIC:
			...
			case boundary_condtion_type::SYMMETRIC:
				...
				if ((k0 == 0) && (l0 == 1))
				{
					int km_lmmm = k0_l0 - 3 * dims.n_pad - 1;
					d_h[km_lmmm] = d_h[k0_l0];
				}
				if ((k0 == 1) && (l0 == 0))
				{
					int kmmm_lm = k0_l0 - dims.n_pad - 3;
					d_h[kmmm_lm] = d_h[k0_l0];
				}
				break;
			}
		...
		case boundary_condtion_type::SYMMETRIC:
			...
			case boundary_condtion_type::SYMMETRIC:
				...
				if ((k0 == 0) && (l0 == dims.m - 2))
				{
					int km_lppp = k0_l0 + 3 * dims.n_pad - 1;
					d_h[km_lppp] = d_h[k0_l0];
				}
				if ((k0 == 1) && (l0 == dims.m - 1))
				{
					int kmmm_lp = k0_l0 + dims.n_pad - 3;
					d_h[kmmm_lp] = d_h[k0_l0];
				}
				break;
			}
		...
		case boundary_condtion_type::SYMMETRIC:
			...
			case boundary_condtion_type::SYMMETRIC:
				...
				if ((k0 == dims.n - 2) && (l0 == 0))
				{
					int kppp_lm = k0_l0 - dims.n_pad + 3;
					d_h[kppp_lm] = d_h[k0_l0];
				}
				if ((k0 == dims.n - 1) && (l0 == 1))
				{
					int kp_lmmm = k0_l0 - 3 * dims.n_pad + 1;
					d_h[kp_lmmm] = d_h[k0_l0];
				}
				break;
			}
		...
		case boundary_condtion_type::SYMMETRIC:
			...
			{
			case boundary_condtion_type::SYMMETRIC:
				if ((k0 == dims.n - 1) && (l0 == dims.m - 1))
				{
					int kp_lp = k0_l0 + dims.n_pad + 1;
					d_h[kp_lp] = d_h[k0_l0];
				}
				if ((k0 == dims.n - 2) && (l0 == dims.m - 1))
				{
					int kppp_lp = k0_l0 + dims.n_pad + 3;
					d_h[kppp_lp] = d_h[k0_l0];
				}
				if ((k0 == dims.n - 1) && (l0 == dims.m - 2))
				{
					int kp_lppp = k0_l0 + 3 * dims.n_pad + 1;
					d_h[kp_lppp] = d_h[k0_l0];
				}
